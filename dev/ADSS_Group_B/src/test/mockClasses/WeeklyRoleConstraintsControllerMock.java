...
public class WeeklyRoleConstraintsControllerMock extends WeeklyRoleConstraintsController {

    public WeeklyRoleConstraintsControllerMock() throws ClassNotFoundException {
    }
    @Override
